...
const MODELS = [
  // RTX 5090 (1,792 GB/s)
  { id: '5090-gemma26b-q6', name: 'Gemma 4 26B-A4B', quant: 'Q6_K', hardware: 'RTX 5090', tier: 'S', tokPerSec: 139, prefillRate: 2900, vram: '26.7 GB', maxCtx: '230K', quality: '17/17', thinking: false, thinkingBudget: 0, color: '#f87171', hwColor: '#86efac' },
  ...
  { id: '5090-qwen27b-base', name: 'Qwen 3.5 27B', quant: 'Q6_K (base)', hardware: 'RTX 5090', tier: 'C', tokPerSec: 50, prefillRate: 1700, vram: '25.6 GB', maxCtx: '256K', quality: '10/17', thinking: false, thinkingBudget: 0, color: '#f87171', hwColor: '#86efac' },
  { id: '5090-gemma-e4b', name: 'Gemma 4 E4B', quant: 'Q8_0', hardware: 'RTX 5090', tier: 'F', tokPerSec: 131, prefillRate: 5000, vram: '12.5 GB', maxCtx: '256K', quality: '5/22', thinking: false, thinkingBudget: 0, color: '#f87171', hwColor: '#86efac' },
  // M4 Max (410 GB/s)
  ...
  { id: 'm4-gemma26b-q6', name: 'Gemma 4 26B-A4B', quant: 'Q6_K', hardware: 'M4 Max', tier: 'S', tokPerSec: 66, prefillRate: 980, vram: '~23 GB', maxCtx: '64K', quality: '15/17', thinking: false, thinkingBudget: 0, color: '#38bdf8', hwColor: '#93c5fd' },
  { id: 'm4-qwen27b-mlx', name: 'Qwen 27B Opus MLX', quant: '4-bit', hardware: 'M4 Max', tier: 'A', tokPerSec: 19, prefillRate: 500, vram: '~14 GB', maxCtx: '128K', quality: '13/17', thinking: false, thinkingBudget: 0, color: '#38bdf8', hwColor: '#93c5fd' },
  ...
  { id: 'm4-qwen9b', name: 'Qwen 3.5 9B', quant: 'Q4_K_M', hardware: 'M4 Max', tier: 'B', tokPerSec: 35, prefillRate: 1750, vram: '~5.5 GB', maxCtx: '128K', quality: '9/17', thinking: false, thinkingBudget: 0, color: '#38bdf8', hwColor: '#93c5fd' },
  { id: 'm4-nemotron4b', name: 'Nemotron 3 Nano 4B', quant: 'Q4_K_M', hardware: 'M4 Max', tier: 'B', tokPerSec: 66, prefillRate: 2900, vram: '~2.8 GB', maxCtx: '128K', quality: '7/17', thinking: true, thinkingBudget: 8192, color: '#38bdf8', hwColor: '#93c5fd' },
  // DGX Spark (273 GB/s)
  { id: 'spark-qwen122b-ik', name: 'Qwen 3.5 122B-A10B', quant: 'Q4_K_M (ik-llama)', hardware: 'DGX Spark', tier: 'S', tokPerSec: 26, prefillRate: 627, vram: '71 GB', maxCtx: '256K', quality: '17/17', thinking: false, thinkingBudget: 0, color: '#a78bfa', hwColor: '#c4b5fd' },
  { id: 'spark-qwen122b-unsloth', name: 'Qwen 3.5 122B-A10B', quant: 'Q4_K_M (mainline)', hardware: 'DGX Spark', tier: 'S', tokPerSec: 21, prefillRate: 600, vram: '72 GB', maxCtx: '256K', quality: '18/17', thinking: false, thinkingBudget: 0, color: '#a78bfa', hwColor: '#c4b5fd' },
  { id: 'spark-glm45', name: 'GLM-4.5-Air', quant: 'Q4_K_M', hardware: 'DGX Spark', tier: 'A', tokPerSec: 22, prefillRate: 627, vram: '70 GB', maxCtx: '128K', quality: '15/17', thinking: false, thinkingBudget: 0, color: '#a78bfa', hwColor: '#c4b5fd' },
  { id: 'spark-qwen122b-reap', name: 'Qwen 122B REAP-20', quant: 'Q4_K_M (pruned)', hardware: 'DGX Spark', tier: 'A', tokPerSec: 29, prefillRate: 700, vram: '57 GB', maxCtx: '256K', quality: '14/17', thinking: false, thinkingBudget: 0, color: '#a78bfa', hwColor: '#c4b5fd' },
  { id: 'spark-qwen122b-mainline', name: 'Qwen 122B-A10B', quant: 'Q4_K_M (bartowski)', hardware: 'DGX Spark', tier: 'A', tokPerSec: 26, prefillRate: 620, vram: '71 GB', maxCtx: '256K', quality: '13/17', thinking: false, thinkingBudget: 0, color: '#a78bfa', hwColor: '#c4b5fd' },
  { id: 'spark-qwen3-coder', name: 'Qwen3-Coder-Next', quant: 'UD-Q4_K_M', hardware: 'DGX Spark', tier: 'B', tokPerSec: 50, prefillRate: 800, vram: '46 GB', maxCtx: '262K', quality: '14/17', thinking: false, thinkingBudget: 0, color: '#a78bfa', hwColor: '#c4b5fd' },
